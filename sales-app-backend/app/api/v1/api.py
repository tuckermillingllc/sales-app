...
from .endpoints import customers, dealer_categories, dealer, feed_product_mapping, dashboard
...
api_router.include_router(dealer.router, prefix="/api/v1", tags=["dealer"])